...
import { generarAlertas, type Alerta } from "../services/alertas.js";
import {
  CERTIFICADO_DIAS_ADVERTENCIA,
  CERTIFICADO_DIAS_CRITICO,
  extraerVencimientoCertificado,
  type VencimientoCertificado,
} from "../services/certificadoDgi.js";
...
//
// El parseo del vencimiento y los umbrales de aviso viven en
// `services/certificadoDgi.ts` (con el porqué de la forma real de la respuesta
// de DGI). Acá queda solo lo que esta capa sí tiene que hacer: la consulta HTTP
// aparte, la tolerancia a que falle, y el armado de la alerta.
